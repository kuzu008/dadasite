...
const SolutionDetailPage = () => {
  ...
  const category = getCategoryById('quantitative-trading');
  const solution = getSolutionById('quantitative-trading', solutionId);
                ...
                <Card key={relatedSolution.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <Button variant="outline" className="w-full" asChild>
                      <Link href={`/solutions/quantitative-trading/${relatedSolution.id}`}>
                        了解详情
                      </Link>
                    </Button>
                  </CardContent>
