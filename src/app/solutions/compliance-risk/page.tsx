...
const ComplianceRiskPage = () => {
  const config = getCategoryById('compliance-risk');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">无法加载合规与风控页面配置</p>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 pt-4">
            <Button className="flex-1" asChild>
              <Link href={`/solutions/compliance-risk/${solution.id}`}>
                了解详情
              </Link>
            </Button>
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center mb-6">
              <div className="w-16 h-16 bg-orange-500 rounded-2xl flex items-center justify-center text-3xl text-white mr-4">
                {config.icon}
              </div>
              <div className="text-left">
                ...
                <p className="text-orange-600 font-medium">{config.englishTitle}</p>
              </div>
            </div>
