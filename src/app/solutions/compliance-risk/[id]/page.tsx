...
const SolutionDetailPage = () => {
  ...
  const category = getCategoryById('compliance-risk');
  const solution = getSolutionById('compliance-risk', solutionId);
                ...
                <Card key={relatedSolution.id} className="hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <Button variant="outline" className="w-full">
                      <Link href={`/solutions/compliance-risk/${relatedSolution.id}`}>
                        了解详情
                      </Link>
                    </Button>
                  </CardContent>
