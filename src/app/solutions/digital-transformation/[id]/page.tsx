...
const SolutionDetailPage = () => {
  ...
  const category = getCategoryById('digital-transformation');
  const solution = getSolutionById('digital-transformation', solutionId);
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                {solution.relatedProducts && solution.relatedProducts.length > 0 && (
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">相关产品</h3>
